module.exports = [
	...
	['emacs-icon', ['dark-purple', 'dark-purple'], /(?:^|\.)(?:elc|eld)$/i, 1.5, /^;ELC\x17\0{3}/],
	...
	['abif-icon', ['medium-blue', 'medium-blue'], /\.abif$/i, /^ABIF/],
	...
	['psd-icon', ['medium-blue', 'medium-blue'], /\.psd$/i, /^8BPS/],
	...
	['audio-icon', ['medium-red', 'medium-red'], /\.mp3$/i, /^\xFF\xFB|^ID3/],
	['audio-icon', ['dark-yellow', 'dark-yellow'], /\.wav$/i, /^RIFF(?!.+WEBP)/],
	['audio-icon', ['dark-cyan', 'dark-cyan'], /\.(?:aac|ac3|m4p)$/i, /^\x0Bw/],
	['audio-icon', ['medium-purple', 'medium-purple'], /\.aif[fc]?$/i, /^FORM.{4}AIFF/],
	['audio-icon', ['medium-cyan', 'medium-cyan'], /\.au$/i, /^\.snd|^dns\./],
	['audio-icon', ['dark-red', 'dark-red'], /\.flac$/i, /^fLaC/],
	['audio-icon', ['medium-red', 'medium-red'], /\.f4[ab]$/i, /^FLV\x01\x04/],
	['audio-icon', ['medium-cyan', 'medium-cyan'], /\.m4a$/i, /^.{4}ftypM4A/],
	['audio-icon', ['dark-green', 'dark-green'], /\.(?:mpc|mp\+)$/i, /^MPCK/],
	['audio-icon', ['dark-orange', 'dark-orange'], /\.oga$/i],
	['audio-icon', ['dark-maroon', 'dark-maroon'], /\.opus$/i, /OpusHead/],
	['audio-icon', ['dark-blue', 'dark-blue'], /\.r[am]$/i, /^\.RMF/],
	...
	['gnu-icon', ['medium-red', 'medium-red'], /\.bison$/i, /\.bison$/i, /^Bis[0o]n$/i],
	...
	['chrome-icon', ['medium-red', 'medium-red'], /\.crx$/i, /^Cr24/],
	...
	['zip-icon', ['medium-blue', 'medium-blue'], /\.rar$|\.wgt$/i, /^Rar!\x1A\x07\x01?\0/],
	['zip-icon', ['dark-blue', 'dark-blue'], /\.t?gz$|\.tar$|\.whl$/i, /^\x1F\x8B/],
	['zip-icon', ['medium-maroon', 'medium-maroon'], /\.(?:lzo?|lzma|tlz|tar\.lzma)$/i, /^LZIP/],
	['zip-icon', ['medium-maroon', 'medium-maroon'], /\.7z$/i, /^7z\xBC\xAF\x27\x1C/],
	['zip-icon', ['medium-red', 'medium-red'], /\.apk$|\.gem$/i],
	['zip-icon', ['dark-cyan', 'dark-cyan'], /\.bz2$/i],
	['zip-icon', ['medium-blue', 'medium-blue'], /\.iso$/i, /^\x45\x52\x02\0{3}|^\x8B\x45\x52\x02/],
	...
	['zip-icon', ['dark-orange', 'dark-orange'], /\.xar$/i, /^xar!/],
	...
	['font-icon', ['dark-blue', 'dark-blue'], /\.woff2$/i, /^wOF2/],
	['font-icon', ['medium-blue', 'medium-blue'], /\.woff$/i, /^wOFF/],
	['font-icon', ['light-green', 'light-green'], /\.eot$/i, /^.{34}LP/],
	['font-icon', ['dark-green', 'dark-green'], /\.ttc$/i, /^ttcf/],
	['font-icon', ['medium-green', 'medium-green'], /\.ttf$/i, /^\0\x01\0{3}/],
	['font-icon', ['dark-yellow', 'dark-yellow'], /\.otf$/i, /^OTTO.*\0/],
	...
	['godot-icon', ['medium-blue', 'medium-blue'], /\.gd$/i, /\.gdscript$/i, /^Gdscript$/i],
	...
	['gears-icon', ['dark-orange', 'dark-orange'], /\.dll$/i, /^PMOCCMOC/],
	[
		'code-icon',
		['medium-blue', 'medium-blue'],
	...
	['code-icon', ['medium-red', 'medium-red'], /\.fo$/i, /^fasto$/, /\.fasto$/i, /^fast[0o]$/i],
	...
	['hy-icon', ['dark-blue', 'dark-blue'], /\.hy$/i, /\.hy$/i, /^Hy$|^hylang$/i],
	...
	['image-icon', ['medium-yellow', 'medium-yellow'], /\.gif$|\.ora$|\.sgi$/i, /^GIF8[97]a/],
	[
		'image-icon',
		['medium-green', 'medium-green'],
		/\.jpg$/i,
	...
	['image-icon', ['medium-blue', 'medium-blue'], /\.ico$/i, /^\0{2}\x01\0/],
	[
		'image-icon',
		['dark-blue', 'dark-blue'],
	...
	['image-icon', ['medium-red', 'medium-red'], /\.bmp$/i, /^BM/],
	['image-icon', ['medium-red', 'medium-red'], /\.bpg$/i, /^BPG\xFB/],
	['image-icon', ['medium-orange', 'medium-orange'], /\.cin$/i, /^\x80\x2A\x5F\xD7/],
	['image-icon', ['dark-green', 'dark-green'], /\.cd5$/i, /^_CD5\x10\0/],
	['image-icon', ['light-yellow', 'light-yellow'], /\.cpc$/i],
	['image-icon', ['medium-orange', 'medium-orange'], /\.cr2$/i, /^II\*\0\x10\0{3}CR/],
	['image-icon', ['medium-pink', 'medium-pink'], /\.dcm$|\.mpo$|\.pbm$/i, /^.{128}DICM/],
	['image-icon', ['dark-green', 'dark-green'], /\.dds$/i, /^DDS \|\0{3}/],
	['image-icon', ['medium-purple', 'medium-purple'], /\.djvu?$|\.pxr$/i, /^AT&TFORM/],
	['image-icon', ['dark-orange', 'dark-orange'], /\.dpx$|\.fig$|\.raw$/i, /^(?:SDPX|XPDS)/],
	['image-icon', ['light-blue', 'light-blue'], /\.ecw$|\.sct$/i],
	['image-icon', ['dark-yellow', 'dark-yellow'], /\.exr$/i, /^v\/1\x01/],
	['image-icon', ['medium-cyan', 'medium-cyan'], /\.fits?$|\.fts$/i, /^SIMPLE  =/],
	[
		'image-icon',
		['dark-red', 'dark-red'],
	...
	['image-icon', ['medium-blue', 'medium-blue'], /\.hdr$/i, /^#\?RADIANCE\n/],
	['image-icon', ['medium-pink', 'medium-pink'], /\.icns$/i, /^icns/],
	['image-icon', ['dark-green', 'dark-green'], /\.(?:jp[f2xm]|j2c|mj2)$/i, /^\0{3}\fjP {2}/],
	['image-icon', ['dark-cyan', 'dark-cyan'], /\.jps$/i],
	['image-icon', ['medium-orange', 'medium-orange'], /\.mng$/i, /^.MNG\r\n\x1A\n/],
	['image-icon', ['light-red', 'light-red'], /\.pgf$/i],
	['image-icon', ['light-purple', 'light-purple'], /\.pict$/i],
	['image-icon', ['dark-orange', 'dark-orange'], /\.tga$/i, /TRUEVISION-XFILE\.\0$/],
	['image-icon', ['medium-red', 'medium-red'], /\.tiff?$/i, /^II\x2A\0|^MM\0\x2A/],
	...
	['imba-icon', ['medium-blue', 'medium-blue'], /\.imba$/i, /\.imba$/, /^Imba$/i],
	[
		'inform7-icon',
		['medium-blue', 'medium-blue'],
		/\.ni$/i,
	...
	['lisp-icon', ['medium-maroon', 'medium-maroon'], /\.l$|\.nl$/i, /picolisp|pil/],
	...
	['markdownlint-icon', ['dark-green', 'dark-green'], /\.markdownlintrc$/i, /^mdl$/],
	...
	['matlab-icon', ['medium-yellow', 'medium-yellow'], /\.matlab$/i, /\.matlab$/i, /^Matlab$/i],
	...
	['mjml-icon', ['medium-red', 'medium-red'], /\.mjml$/i, /\.mjml$/i, /^Mjml$/i],
	[
		'model-icon',
		['medium-red', 'medium-red'],
		/\.obj$|\.geo(?:m|metry)?$/i,
	...
	['model-icon', ['dark-blue', 'dark-blue'], /\.mtl$/i, /\.wavefront\.mtl$/i],
	[
		'model-icon',
		['medium-cyan', 'medium-cyan'],
		/\.shader$/i,
	...
	['music-icon', ['dark-blue', 'dark-blue'], /\.midi?$/i, /^MThd/],
	[
		'music-icon',
		['medium-green', 'medium-green'],
		/\.ly$/i,
	...
	['octave-icon', ['medium-orange', 'medium-orange'], /\.octave$/i, /\.octave$/i, /^[0o]ctave$/i],
	...
	['osx-icon', ['medium-red', 'medium-red'], /\.dmg$/i, /^\x78\x01\x73\x0D\x62\x62\x60/],
	...
	['icon-file-pdf', ['medium-red', 'medium-red'], /\.pdf$/i, /^%PDF/],
	...
	['android-icon', ['medium-green', 'medium-green'], /\.smali$/i, /\.smali$/i, /^Smali$/i],
	...
	['gnome-icon', ['medium-purple', 'medium-purple'], /\.vala$/i, /^vala$/, /\.vala$/i, /^vala$/i],
	...
	['video-icon', ['medium-blue', 'medium-blue'], /\.3gpp?$/i, /^.{4}ftyp3g/],
	['video-icon', ['dark-blue', 'dark-blue'], /\.(?:mp4|m4v|h264)$/i, /^.{4}ftyp/],
	['video-icon', ['medium-blue', 'medium-blue'], /\.avi$/i, /^MLVI/],
	['video-icon', ['medium-cyan', 'medium-cyan'], /\.mov$/i, /^.{4}moov/],
	['video-icon', ['medium-purple', 'medium-purple'], /\.mkv$/i, /^\x1AEß£\x93B\x82\x88matroska/],
	['video-icon', ['medium-red', 'medium-red'], /\.flv$/i, /^FLV\x01/],
	['video-icon', ['dark-blue', 'dark-blue'], /\.webm$/i, /^\x1A\x45\xDF\xA3/],
	['video-icon', ['medium-red', 'medium-red'], /\.mpe?g$/i, /^\0{2}\x01[\xB3\xBA]/],
	['video-icon', ['dark-purple', 'dark-purple'], /\.(?:asf|wmv)$/i, /^0&²u\x8EfÏ\x11¦Ù\0ª\0bÎl/],
	['video-icon', ['medium-orange', 'medium-orange'], /\.(?:ogm|og[gv])$/i, /^OggS/],
	[
		'vim-icon',
		['medium-green', 'medium-green'],
		/\.(?:vim|[gn]?vimrc)$/i,
